...
public class AdminAcceptedUsers extends Activity
{
    @Override
    public void onCreate(Bundle bundle)
    {
        ...
        String query = new SignIn().getFromSocket("/au/getAcceptedUsers"+"?un="+Data.getUsername()+"&pw="+Data.getPassword());
        long tmp = 1;
        try
        {
            ...
            try
            {
                ...
                searchResult.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                    ...
                    public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
                        ...
                        AlertDialog.Builder builder = new AlertDialog.Builder(AdminAcceptedUsers.this);
